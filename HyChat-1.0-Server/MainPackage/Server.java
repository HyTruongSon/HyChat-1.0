...
public class Server extends JFrame {
    ...
    // Constants/Variables for Graphics User Interface
    private final String frameTitle = "Server";
    ...
    public Server() {
        ...
        label = new JLabel();
        label.setText("Server terminal:");
        label.setForeground(Color.blue);
        label.setBounds(0, 0, frameWidth, componentHeight);
        add(label);
        
        terminal = new JTextArea();
        terminal.setEditable(false);
        terminal.setBounds(0, componentHeight, frameWidth, frameHeight - componentHeight);
        terminal.setLineWrap(true);
        
        terminalScroll = new JScrollPane (terminal);
        terminalScroll.setBounds(0, componentHeight, frameWidth, frameHeight - componentHeight);
        terminalScroll.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
